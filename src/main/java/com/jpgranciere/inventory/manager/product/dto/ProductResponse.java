...
public record ProductResponse(Long id, String name, String description, String sku,
                              ProductCategory category, int stockQuantity, int minStockQuantity, ProductStatus status, BigDecimal price, String gtin)

{
    public ProductResponse(Product product) {
        this(product.getId(), product.getName(), product.getDescription(), product.getSku(), product.getCategory(), product.getStockQuantity(), product.getMinStockQuantity(),
                product.getStatus(), product.getPrice(), product.getGtin());
    }
}
